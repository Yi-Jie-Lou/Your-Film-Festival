...
function TemplateFeatureContainer() {
          ...
          <div className=" mt-16 pb-12">
            ...
            <div className="vertical mx-auto mt-8 w-4/5">
              {currentFeature.timetable.map((timetable, index) => (
                <NavLink key={index} to={`/timetable/${timetable.date}`}>
                  <div className="flex py-2 px-4 my-2 justify-between border-2 rounded-lg border-stone-700 bg-orange-300">
                    <p>
...
function PreviewFeatureContainer() {
  const features = useSelector((state) => state.features);
              ...
              {currentFeature.timetable.map((timetable, index) => (
                ...
                >
                  <div
                    ...
                    className="flex py-2 px-4 my-2 justify-between border-2 rounded-lg border-stone-700"
                  >
                    <p>
                      {timetable.date} {timetable.start}
                    </p>
